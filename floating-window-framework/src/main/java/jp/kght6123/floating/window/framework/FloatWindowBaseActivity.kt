 ...
 */
abstract class FloatWindowBaseActivity : Activity() {
    ...
    lateinit protected var launcher : FloatWindowLauncher
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.launcher = object : FloatWindowLauncher(this){
            override fun onServiceConnected(name: ComponentName?, binder: IBinder?) {
                super.onServiceConnected(name, binder)
                this@FloatWindowBaseActivity.onLauncherServiceConnected(name, binder)
            }
            override fun onFindNextIndex(nextIndex: Int, returnCommand: Int) {
                super.onFindNextIndex(nextIndex, returnCommand)
                this@FloatWindowBaseActivity.onFindNextIndex(nextIndex, returnCommand)
            }
            override fun onFindPrevIndex(prevIndex: Int, returnCommand: Int) {
                super.onFindPrevIndex(prevIndex, returnCommand)
                this@FloatWindowBaseActivity.onFindPrevIndex(prevIndex, returnCommand)
            }
        }
    ...
    open fun onAppWidgetResult(result: Boolean) {}
}