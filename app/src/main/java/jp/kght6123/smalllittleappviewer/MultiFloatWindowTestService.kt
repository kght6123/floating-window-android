...
class MultiFloatWindowTestService : Service() {
	...
	override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
		...
		val info1 = manager.add(1, false, margin, margin, getColor(android.R.color.background_light), initWidth, initHeight, false)
		info1.miniWindowFrame.addView(iconView1, iconViewLayoutParam1)
		info1.windowInlineFrame.addView(webView1)

		val info2 = manager.add(2, false,margin*2, margin*2, getColor(android.R.color.background_light), initWidth, initHeight, false)
